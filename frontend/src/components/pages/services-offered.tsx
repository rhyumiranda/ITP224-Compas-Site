...
export default function ServicesOfferedSection() {
  return (
    <div className="wrapper flex flex-col gap-8 py-10" id="services">
      <h1 className="text-4xl text-center font-semibold pb-5">Our Services</h1>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
        <div className="text-center flex justify-center items-center flex-col">
          <div className="bg-gray-300 w-15 h-15 rounded-full mb-6 flex justify-center items-center">
        ...
        <div className="text-center flex justify-center items-center flex-col">
          <div className="bg-gray-300 w-15 h-15 rounded-full mb-6 flex justify-center items-center">
            <Sailboat className="w-6 h-6 text-gray-600" />
          </div>
